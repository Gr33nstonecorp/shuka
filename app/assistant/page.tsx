...
export default function AssistantPage() {
  ...
  const hasAccess = hasActivePaidPlan(profile); // This should respect trial if your helper function does
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!hasAccess) {
      setMessage("Active paid subscription or trial required for AI Assistant.");
      setRunning(false);
      return;
    }
      ...
      <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex items-center justify-center p-6">
        <div className="max-w-md text-center">
          ...
          <p className="text-zinc-600 mb-8">
            Active paid subscription or free trial required for the AI Assistant.
          </p>
          <Link
            href="/pricing"
