              ...
              {user ? (
                <div className="flex items-center gap-3">
                  ...
                  <form action="/auth/signout" method="post">
                    <button 
                      type="submit"
                      className="px-5 py-2 text-sm border border-red-300 dark:border-red-700 text-red-600 dark:text-red-400 rounded-xl hover:bg-red-50 dark:hover:bg-red-950 transition"
                    >
                      Log out
                    </button>
                  </form>
                ...
                <Link 
                  href="/login" 
                  className="px-5 py-2 text-sm border border-zinc-300 dark:border-zinc-700 rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-800 transition"
                >
                  Log in
                </Link>
              )}
        ...
        <footer className="border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 mt-auto">
          <div className="max-w-6xl mx-auto px-6 py-10 text-center md:text-left">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-sm">
              <div className="font-bold">ShukAI</div>
              <div className="flex flex-wrap gap-x-8 gap-y-2 text-zinc-600 dark:text-zinc-400">
                ...
                <Link href="/msa" className="hover:text-black dark:hover:text-white">Agreement</Link>
                <Link href="/pricing" className="hover:text-black dark:hover:text-white font-medium text-blue-600">Support Us</Link>
              </div>
